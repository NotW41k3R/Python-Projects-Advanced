...
It supports full CRUD operations: get random cafés, list all cafés, search by location, add new entries, update prices, and delete cafés with an API key, tested using postman.
